...
# SONATA2
    ...
    #OPPONENT=OPPONENT=OPPONENT=OPPONENT=OPPONENT=OPPONENT=OPPONENT=OPPONENT=OPPONENT=OPPONENT=OPPONENT=OPPONENT=
        ...
        output_basic['opponentAverageResourcesAvailable'] = (
                    output_basic['opponentAverageMineralsAvailable'] + output_basic[
                'opponentAverageVespeneAvailable'])
        ...
        if len(replay_data.players) > 2:
            ...
            output_basic['opponentHotkeysSetaddTotal'] = len(replay_data.players[opponent_entity - 1]['hotkey_add']) + len(
                replay_data.players[opponent_entity - 1]['hotkey_set'])
